...
CREATE TABLE `course` (
  ...
  `title` varchar(1024) NOT NULL COMMENT '产品标题',
  `subtitle` varchar(1024) NOT NULL DEFAULT '' COMMENT '产品副标题',
  `status` enum('draft','published','closed') NOT NULL DEFAULT 'draft' COMMENT '产品状态',
  `type` varchar(255) NOT NULL DEFAULT 'normal' COMMENT '产品类型',
  `maxStudentNum` int(11) NOT NULL DEFAULT '0' COMMENT '直播产品最大顾客数上线',
  `price` float(10,2) NOT NULL DEFAULT '0.00' COMMENT '产品价格',
  `originPrice` FLOAT(10,2) NOT NULL DEFAULT  '0.00' COMMENT '产品人民币原价',
  `coinPrice` FLOAT(10,2) NOT NULL DEFAULT 0.00,
  `originCoinPrice` FLOAT(10,2) NOT NULL DEFAULT  0 COMMENT '产品虚拟币原价',
  `expiryDay` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '产品过期天数',
  `showStudentNumType` enum('opened','closed') NOT NULL DEFAULT 'opened' COMMENT '顾客数显示模式',
  ...
  `lessonNum` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '产品介绍数',
  `giveCredit` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '查看完产品所有产品介绍，可获得的总积分',
  ...
  `teacherIds` text COMMENT '显示的产品商家IDs',
  `goals` text COMMENT '产品目标',
  ...
  `locationId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '浏览地区ID',
  `address` varchar(255) NOT NULL DEFAULT '' COMMENT '浏览人地区地址',
  `studentNum` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '顾客数',
  `hitNum` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '查看次数',
  `userId` int(10) unsigned NOT NULL COMMENT '产品发布商家ID',
  ...
  `useInClassroom` ENUM('single','more') NOT NULL DEFAULT 'single' COMMENT '产品能否用于多个班级' , 
  `watchLimit` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视频观看次数限制',
  `singleBuy` INT(10) UNSIGNED NOT NULL DEFAULT '1' COMMENT '加入浏览后产品能否单独购买' ,
  `createdTime` int(10) unsigned NOT NULL COMMENT '产品创建时间',
...
CREATE TABLE `course_announcement` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '产品公告ID',
  `userId` int(10) NOT NULL COMMENT '公告发布人ID',
  `courseId` int(10) NOT NULL COMMENT '公告所属产品ID',
...
CREATE TABLE `course_chapter` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '产品章节ID',
...
CREATE TABLE `course_draft` (
  ...
  `lessonId` int(10) unsigned NOT NULL COMMENT '产品介绍ID',
  `createdTime` int(10) unsigned NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `course_lesson` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '产品介绍ID',
  `courseId` int(10) unsigned NOT NULL COMMENT '产品介绍所属产品ID',
  `chapterId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '产品介绍所属章节ID',
  `number` int(10) unsigned NOT NULL COMMENT '产品介绍编号',
  `seq` int(10) unsigned NOT NULL COMMENT '产品介绍在产品中的序号',
  `free` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否为免费产品介绍',
  `status` enum('unpublished','published') NOT NULL DEFAULT 'published' COMMENT '产品介绍状态',
  `title` varchar(255) NOT NULL COMMENT '产品介绍标题',
  `summary` text COMMENT '产品介绍摘要',
  `tags` text COMMENT '产品介绍标签',
  `type` varchar(64) NOT NULL DEFAULT 'text' COMMENT '产品介绍类型',
  `content` text COMMENT '产品介绍正文',
  `giveCredit` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '查看完产品介绍获得的积分',
  `requireCredit` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '查看产品介绍前，需达到的积分',
  ...
  `learnedNum` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '已浏览的顾客数',
  `viewedNum` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '查看数',
  `startTime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '直播产品介绍开始时间',
  `endTime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '直播产品介绍结束时间',
  `memberNum` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '直播产品介绍加入人数',
...
CREATE TABLE `course_lesson_learn` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '顾客产品介绍查看记录ID',
  `userId` int(10) unsigned NOT NULL COMMENT '顾客ID',
  `courseId` int(10) unsigned NOT NULL COMMENT '产品ID',
  `lessonId` int(10) unsigned NOT NULL COMMENT '产品介绍ID',
  `status` enum('learning','finished') NOT NULL COMMENT '查看状态',
  `startTime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '查看开始时间',
  `finishedTime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '查看完成时间',
  `learnTime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '查看时间',
  `watchTime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '查看观看时间',
  `watchNum` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '观看次数',
  `videoStatus` enum('paused','playing') NOT NULL DEFAULT 'paused' COMMENT '查看观看时间',
...
CREATE TABLE IF NOT EXISTS `course_lesson_replay` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `lessonId` int(10) unsigned NOT NULL COMMENT '所属产品介绍',
  `courseId` int(10) unsigned NOT NULL COMMENT '所属产品',
...
CREATE TABLE `course_material` (
  ...
  `courseId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '资料所属产品ID',
  `lessonId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '资料所属产品介绍ID',
...
CREATE TABLE `course_member` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '产品顾客记录ID',
  `courseId` int(10) unsigned NOT NULL COMMENT '产品ID',
  `classroomId` INT(10) NOT NULL DEFAULT '0'  COMMENT '班级ID',
  `joinedType` ENUM('course','classroom') NOT NULL DEFAULT 'course' COMMENT '购买班级或者产品加入查看',
  `userId` int(10) unsigned NOT NULL COMMENT '顾客ID',
  `orderId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '顾客购买产品时的订单ID',
  `deadline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '查看最后期限',
  `levelId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户以会员的方式加入产品顾客时的会员ID',
  `learnedNum` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '已浏览产品介绍数',
  `credit` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '顾客已获得的积分',
  ...
  `isLearned` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否已查看完',
  `seq` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序序号',
  `remark` varchar(255) NOT NULL DEFAULT '' COMMENT '备注',
  `isVisible` tinyint(2) NOT NULL DEFAULT '1' COMMENT '可见与否，默认为可见',
  `role` enum('student','teacher') NOT NULL DEFAULT 'student' COMMENT '产品会员角色',
  `locked` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '顾客是否被锁定',
  `deadlineNotified` int(10) NOT NULL DEFAULT '0' COMMENT '有效期通知',
  `createdTime` int(10) unsigned NOT NULL COMMENT '顾客加入产品时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `course_note` (
  ...
  `lessonId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '产品介绍ID',
...
CREATE TABLE `course_review` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '产品评价ID',
  `userId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '评价人ID',
  `courseId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '被评价的产品ID',
...
CREATE TABLE `course_thread` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '产品话题ID',
  `courseId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '话题所属产品ID',
  `lessonId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '话题所属产品介绍ID',
...
CREATE TABLE `course_thread_post` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '产品话题回复ID',
  `courseId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '回复所属产品ID',
  `lessonId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '回复所属产品介绍ID',
...
CREATE TABLE `testpaper` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '问卷ID',
  `name` varchar(255) NOT NULL DEFAULT '' COMMENT '问卷名称',
  ...
  `target` varchar(255) NOT NULL DEFAULT '' COMMENT '问卷所属对象',
  ...
  `passedScore` float(10,1) unsigned NOT NULL DEFAULT '0.0' COMMENT '通过问卷的分数线',
...
CREATE TABLE `testpaper_item` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '问卷条目ID',
...
CREATE TABLE `testpaper_item_result` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '问卷题目做题结果ID',
  `itemId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '问卷条目ID',
  `testId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '问卷ID',
...
CREATE TABLE `testpaper_result` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '问卷结果ID',
  ...
  `passedStatus` enum('none','passed','unpassed') NOT NULL DEFAULT 'none' COMMENT '问卷通过状态，none表示该问卷没有',
  ...
  `target` varchar(255) NOT NULL DEFAULT '' COMMENT '问卷结果所属对象',
  `checkTeacherId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '批卷商家ID',
