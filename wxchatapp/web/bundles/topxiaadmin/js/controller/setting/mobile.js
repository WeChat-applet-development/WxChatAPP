    ...
    exports.run = function() {
        ...
        $("#mobile-splash1-remove").on('click', function(){
            ...
            $.post($btn.data('url'), function(){
                ...
                $btn.hide();
                Notify.success('删除平台启动图1成功！');
            }).error(function(){
                Notify.danger('删除平台启动图1失败！');
            });
        });
        ...
        $("#mobile-splash2-remove").on('click', function(){
            ...
            $.post($btn.data('url'), function(){
                ...
                $btn.hide();
                Notify.success('删除平台启动图2成功！');
            }).error(function(){
                Notify.danger('删除平台启动图2失败！');
            });
        });
        ...
        $("#mobile-splash3-remove").on('click', function(){
            ...
            $.post($btn.data('url'), function(){
                ...
                $btn.hide();
                Notify.success('删除平台启动图3成功！');
            }).error(function(){
                Notify.danger('删除平台启动图3失败！');
            });
        });
        ...
        $("#mobile-splash4-remove").on('click', function(){
            ...
            $.post($btn.data('url'), function(){
                ...
                $btn.hide();
                Notify.success('删除平台启动图4成功！');
            }).error(function(){
                Notify.danger('删除平台启动图4失败！');
            });
        });
        ...
        $("#mobile-splash5-remove").on('click', function(){
            ...
            $.post($btn.data('url'), function(){
                ...
                $btn.hide();
                Notify.success('删除平台启动图5成功！');
            }).error(function(){
                Notify.danger('删除平台启动图5失败！');
            });
        });
        ...
        $("#mobile-logo-remove").on('click', function(){
            ...
            $.post($btn.data('url'), function(){
                ...
                $btn.hide();
                Notify.success('删除平台LOGO成功！');
            }).error(function(){
                Notify.danger('删除平台LOGO失败！');
            });
        });
